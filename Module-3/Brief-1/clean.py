...
# 0. Load CSV
df = pd.read_csv('./resources/data-all.csv')
...
col_to_drop = ['nom', 'prenom', 'nationalité_francaise', 'sexe', 'region', 'smoker', 'poids', 'taille']
...
cols_numeriques = ['age', 'revenu_estime_mois', 'loyer_mensuel', 'montant_pret', 'risque_personnel']
